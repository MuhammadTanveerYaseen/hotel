  ...
  return (
    <section>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(/HotelAOneMultan/IMG-20240928-WA0007.jpg)`,
        }}
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4 md:px-8 lg:px-16 space-y-6">
          ...
          <Link href={"https://wa.me/+923252866262?text=I%20want%20to%20book%20the%20Standard%20Room"}>Book Now</Link>
          </button>
        </div>
      </div>
